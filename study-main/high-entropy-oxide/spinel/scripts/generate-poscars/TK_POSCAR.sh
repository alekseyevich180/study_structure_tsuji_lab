...
python_dir="$REMOTE_DIR$WORK_DIR/scripts/generate-poscars/spinel_poscar_generator.py"
log_file="$REMOTE_DIR$WORK_DIR/scripts/generate-poscars/generate_spinel_poscar.log"
