...
directory = f"{LOCAL_DIR}{WORK_DIR}/structures/one_million_models/POSCARs"
# ディレクトリが存在しない場合は作成する
os.makedirs(directory, exist_ok=True)

features_ID_d = {}

ROOT_PATH = f"{LOCAL_DIR}{WORK_DIR}/calc"
...
for i in range(1, 10):
    ...
    fe_nsw = 1000 if random.random() < 0.1 else 0
    fe_force = 1 if random.random() < 0.1 else 0.0001
